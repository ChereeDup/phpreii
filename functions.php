...
function personalinfoe ($id){
    ...
    $dbimage = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
...
function selectwerk($id){
    $dbsearch = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
    $sql = "SELECT * FROM population WHERE username = '$id'";
...
function tablegenerator ($id) {
    $dbmedical = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
...
function check($id){
    $dbcheck = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
    $sql = "SELECT * FROM population WHERE username = '$id'";
...
function addnew() {
    ...
    $gender = $_POST['gender'];
    echo "$id";
    $dbedit = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
    $sql = "SELECT * FROM population WHERE username = '$id'";
...
function birthcertificate(){
    ...
    $authphar = 0;
    $authpath = 0;
    $dbbirth = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
...
function add() { 
    ...
    $date = $_POST['date'];
    $id = $_POST['id'];
    $dbdata = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
...
function checkboxcheck($id){
    ...
    <?php
    $db = mysqli_connect('localhost','root','MySQLRootPasswordCheree@123','medicaldatabase');
    if(isset($_POST['aut'])){
